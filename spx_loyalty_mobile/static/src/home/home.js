...
export class JennysRewardsHome extends Component {
    ...
    setup() {
        ...
        this.shortcuts = [
            ...
            {
                key: "birthday", action: "birthday_action", title: _t("Birthday credits"),
                description: _t("A birthday treat, with a native balance and expiry."),
                link: _t("View birthday credits"), tone: "gold",
