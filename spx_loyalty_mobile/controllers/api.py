...
class MobileAPI(http.Controller):
    def _scope(self):
        ...
        if not user._mobile_verified_access():
            raise AccessError(_('Verify your email before using your account. If you need help, contact Jenny’s.'))
    ...
    def preferences(self, promotional_email, promotional_sms=None):
        website, partner = self._scope()
